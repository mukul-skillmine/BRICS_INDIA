...
const RegistrationPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br mt-8 p-5 flex items-center justify-center">
      <div className="bg-white rounded-xl shadow-2xl max-w-6xl w-full p-10 my-5">
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="flex gap-2">
                ...
                <button
                  type="button"
                  className="px-6 py-3 bg-white border border-slate-300 rounded-lg text-indigo-700 text-sm font-semibold hover:bg-slate-50 hover:border-indigo-700 transition-all whitespace-nowrap"
                >
                  Verify
                </button>
              </div>
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="flex gap-2">
                <select
                  ...
                  className={`w-36 px-4 py-3 border rounded-lg text-sm text-slate-800 bg-white transition-all focus:outline-none focus:ring-2 focus:ring-indigo-700 focus:border-transparent ${
            ...
            <div className="flex flex-col gap-2 md:col-span-2">
              ...
              <div className="border-2 border-dashed border-slate-300 rounded-xl p-8 text-center hover:border-indigo-700 hover:bg-slate-50 transition-all cursor-pointer">
                ...
                <label htmlFor="photo" className="flex flex-col items-center gap-4 cursor-pointer">
                  ...
                  <button type="button" className="px-6 py-2 bg-white border border-slate-300 rounded-lg text-slate-700 text-sm font-medium hover:bg-slate-50 hover:border-indigo-700 hover:text-indigo-700 transition-all">
                    Browse File
                  </button>
                </label>
              </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center mt-10 pt-6 border-t border-slate-200 gap-4">
            ...
            <button
              type="submit"
              className="w-full md:w-auto px-12 py-3 bg-indigo-700 text-white rounded-lg text-base font-semibold hover:bg-indigo-800 hover:-translate-y-0.5 hover:shadow-lg transition-all"
            >
              Next
            </button>
          </div>
